...
you_learn:"Tu as appris à utiliser '%s' !",
you_unlock:"Tu peux maintenant aller dans '%s' !",
you_success:"Fini '%s' !",
...
"user_judged-lovely":"Oh c'est mignon. Est-ce que vous essayé de me soudoyer ?",
...
people_shell_text6:"<voice grl/>Sais-tu ce qu'est une expression régulière ? Non ? Par exemple \"Bo*\" est une expression régulière pour \"Bonbon\", mais aussi pour \"Bobine\" et tous les mots commençant par les lettres B o.\n Le caractère * (astérisque) signifie : n'importe quel caractère, autant de fois que possible.",
people_shell_text0:"<voice grl/>Je n'ai ni yeux ni jambes.\nJe me déplace avec '{{cmd.cd}}'.\nJe vois les routes et obstacles avec '{{cmd.ls}}'.\nJ'examine le contenu avec '{{cmd.cat}}' ou parfois avec un éditeur.\nEt parfois, j'exécute…",
...
cmd_cat_second_try:"Tiens ! Là ! Il y a une {{people_shell}}, on pourrait lui demander comment elle a fait pour venir jusqu'ici.\nVous vous connaissez peut-être.\n Tu n'as qu'à écrire '{{cmd.cat}} {{people_shell}}' pour engager cette passionnante discussion.",
...
people_poney_texthelp:"«<voice poney/> J'ai compris ! Tu es bloqué » <voice char/>dit le poney.«<voice poney/> Désolé, je ne suis pas en mesure de t'aider.\nmais si tu as déjà lu le {{item_man}} tu dois pouvoir utiliser '{{cmd.help}}' » .",
...
room_dank:"PièceHumide",
room_dank_text:"Cette pièce est encore plus sombre.",
item_boulder:"Rocher",
item_boulder_text:"Tu sens un léger courant d'air passer derrière le rocher.",
room_small_hole:"PetiteCrevasse",
room_small_hole_text:"Il n'y a rien de très plaisant dans cette crevasse remplie de saletés.\nCette crevasse est à peine plus volumineuse que le rocher.",
room_small_hole_cd:"Pas très agréable comme endroit. \nJe veux sortir.",
room_tunnel:"Tunnel",
room_tunnel_text:"Le taux d'humidité ici est très élevé.\nTu reçois des gouttes d'eau sur la figure.\nTu as remarqué une touffe de poil se déplaçant à ta droite.\nAu bout de tunnel, il y a une porte ouverte.",
...
room_townsquare_text:"Tu te trouves sur une place du village, grande et ensoleillée.\nAu centre, il y a un piédestal sur lequel ne se trouve aucune statue.\nL'architecture est très jolie, mais tout le monde semble nerveux.",
...
people_citizen2_text:"Ce villageois lit le journal quand il remarque que tu le regardes. \n\"As-tu lu ça ?\" s'esclaffe-t-il, secouant la dernière édition du \"Dernier Mot\" devant ton visage.\n\"Ça dit que {{people_darkwizard_pre}} {{people_darkwizard}} a répandu la corruption de Oseton jusqu'au sud et Konsole est déjà atteint !\nLes temps sont dangereux.\" \nmarmonne-t-il, secouant sa tête et retournant à sa lecture.",
...
unzipped:"Dans %s, tu as trouvé ces choses : %s",
...
item_backpack_text:"Il y a un sac à dos avec ouverture zippée super classe sur la table sans prix dessus. Sa toile est un peu effilochée mais il semble robuste.\nTu jettes un coup d'œil sur le vendeur mais son attention est ailleurs.\nUne inscription apparaît près de la languette du sac : 'unzip'. ",
...
people_cryingman_text:"<voice grl>\"Vous ! Vous faites partie des mercenaires du {{people_darkwizard}} ! Je peux la sentir cette capacité étrange que vous avez.\nVous êtes venu·e finir le travail, n'est-ce pas ?\nAllez ! Qu'est-ce que vous attendez ? Faites votre sale boulot, il ne me reste plus rien à perdre.\n\n<voice char>« Mais enfin ! Que s'est-il passé ? »\n\n<voice grl>\"Qu'est-il arrivé ? Vous OSEZ nous le demander ? — Vous savez parfaitement ce qui est arrivé. \nVos copains, ils sont venus, il y a deux jours. Ils ont détruit ma maison et enlevé mon pauvre enfant.\nMa femme est partie en ville pour trouver de l'aide, mais depuis, elle a disparu.\n\n<voice char>« C'est affreux. Que puis-je faire pour vous venir en aide ? »\n\n<voice grl>\"Comment ? D'accord, j'imagine que vous n'avez rien à voir avec ceci. Vous ne ressemblez pas aux soldats du {{people_darkwizard}}.\nCeci dit, je n'ai pas confiance en vous.\nSi vous êtes vraiment bien intentionné, alors prouvez-le en me construisant une nouvelle {{room_house}} !",
room_house:"Maison",
...
room_clearing_less2:"Merci du fond du cœur pour m'avoir construit cette {{room_house}} ! J'en pleure de joie.\nY a t'il beaucoup d'autres personnes comme toi ?\nEs-tu capable de libérer mon enfant ?\nDésolé, je t'en demande beaucoup trop, mais tu es mon seul espoir pour retrouver ma famille.",
room_brokenbridge:"PontCassé",
room_brokenbridge_text:"Un pont de bois grinçant s'étend au dessus d'un abîme.\nMais une {{item_plank}} manque, et le trou est trop grand pour être enjambé.",
room_brokenbridge_text2:"Devant toi, un pont tenu par des cordes s'étend vers l'abîme.",
item_plank:"Planche",
...
item_brambles_text:"Ce tas de ronces est couvert d'épines qui ne t'inspirent vraiment pas confiance.\nTu ne peux pas le contourner et tu n'essaieras sûrement pas de le traverser.\nPourtant, quelque chose te dit que derrière ce tas de ronces se trouve quelque chose d'important.",
item_brambles_mv:"Tu ne peux pas toucher les ronces à cause de ces maudites épines.",
item_brambles_rm:"Lorsque tu invoques '{{cmd.rm}}' sur le tas de ronces,\nces dernières émettent une lueur d'un bleu très profond.\nAu bout d'un moment, les ronces disparaissent dans un nuage de fumée.",
room_slide:"Toboggan",
...
room_kernel_text:"Les FichiersNoyau détiennent le sudo secret (non, ce n'est pas un pseudo). Vous avez intérêt à lire le fichier d'instructions.",
ask_password:"Mot de passe :",
room_kernel_IHTFP:"Vous avez correctement saisi le mot de passe. Vous êtes maintenant au Paradis. Regardez autour de vous, Félicitations !",
item_certificate:"Certificat",
item_certificate_alert:"Vous devez lire le Certificat avec le mot de passe sudo.",
...
gameover3:"Bon comme je t'ai déjà dis 'au revoir', je vais t'ignorer. M'en veux pas, hein.",
item_instructions:"Instructions",
item_instructions_text:"Vous avez probablement appris à utiliser le sort grep. Si ce n'est pas encore le cas, il serait sage que vous vous rendiez dans la bibliothèque afin d'y remédier. Parce qu'ici vous aurez besoin de l'utiliser pour parvenir à vos fins. Voici votre tâche : \nIl y de nombreux objets entreposés dans la salle PlusDeFichiersNoyau et l'un d'entre eux contient le mot de passe sudo. Ce mot de passe est très puissant : il vous permet de faire absolument tout ce que vous voulez dans l'univers. Il vous permet de lancer n'importe quel sort sur n'importe quel objet, même protégé. Vous savez que le mot de passe est caché dans une de ces fichiers .txt. Vous savez qu'il se trouve dans la ligne qui contient le mot : « password= ». Vous devriez réussir à le trouver avec l'aide de grep. Ensuite, vous devrez utiliser le sort sudo pour atteindre le Paradis. Pour cela, tapez simplement « sudo » avant la commande que vous voulez appliquer. Il vous sera alors demandé le mot de passe sudo. Saisissez-le, et le sort à la suite de sudo sera alors appliqué. Lisez le Certificat avec sudo et vous ne serez pas venu jusqu'ici pour rien...",
...
item_bigfile_text:"Alice, assise auprès de sa sœur sur le gazon, commençait à s’ennuyer \nde rester là à ne rien faire ; une ou deux fois elle avait jeté les yeux sur \nle livre que lisait sa sœur ; mais quoi ! pas d’images, pas de dialogues ! \n« La belle avance, » pensait Alice, « qu’un livre sans images, sans \ncauseries ! » \nCe texte contient des millions de mots.\nCela prendrait des heures de tout lire.",
item_bigfileM_text:"Alice, assise auprès de sa sœur sur le gazon, commençait à s’ennuyer \nde rester là à ne rien faire ; une ou deux fois elle avait jeté les yeux sur \nle livre que lisait sa sœur ; mais quoi ! pas d’images, pas de dialogues ! \n« La belle avance, » pensait Alice, « qu’un livre sans images, sans \ncauseries ! » \nCe texte contient des millions de mots.\nCela prendrait des heures de tout lire.",
item_bigfileQ_text:"Alice, assise auprès de sa sœur sur le gazon, commençait à s’ennuyer \nde rester là à ne rien faire ; une ou deux fois elle avait jeté les yeux sur \nle livre que lisait sa sœur ; mais quoi ! pas d’images, pas de dialogues ! \n« La belle avance, » pensait Alice, « qu’un livre sans images, sans \ncauseries ! » \nCe texte contient des millions de mots.\nCela prendrait des heures de tout lire.",
item_bigfileS_text:"Alice, assise auprès de sa sœur sur le gazon, commençait à s’ennuyer \nde rester là à ne rien faire ; une ou deux fois elle avait jeté les yeux sur \nle livre que lisait sa sœur ; mais quoi ! pas d’images, pas de dialogues ! \n« La belle avance, » pensait Alice, « qu’un livre sans images, sans \ncauseries ! » \nCe texte contient des millions de mots.\nCela prendrait des heures de tout lire.",
item_bigfileT_text:"Alice, assise auprès de sa sœur sur le gazon, commençait à s’ennuyer \nde rester là à ne rien faire ; une ou deux fois elle avait jeté les yeux sur \nle livre que lisait sa sœur ; mais quoi ! pas d’images, pas de dialogues ! \n« La belle avance, » pensait Alice, « qu’un livre sans images, sans \ncauseries ! » \nCe texte contient des millions de mots.\nCela prendrait des heures de tout lire.",
room_trollcave:"CaveDesTrolls",
room_trollcave_text:"TLa vace est sombre et elle sent… les pieds ?! Ah, d'accord, ce sont probablement les trolls. \nSur la mur du fond, il y a un enfant enfermé dans une cage qui à l'air effrayé.",
people_troll1:"TrollMoche",
people_troll1_text:"Il a l'air fou, et vraiment très moche.",
people_troll1_mv:"Le troll semble avoir été surpris, puis il s'en va.\nDe toutes façons, il est inofffensif.",
people_troll1_rm:"Le troll semble avoir été surpris, puis il disparaît \ndans un bruit désagrable de pataugeage.",
people_troll1_cp:"Ils se multiplient !",
people_troll2:"TrollPlusMoche",
people_troll2_text:"Il a l'air fou et vraiment vraiment moche. \nMais il veut te dire quelque chose. Entre deux \ngrognements incompréhensibles, tu parviens à discerner les mots suivants : \nTu peux jeter des sorts sur les objets que tu ne vois actuellement. Par exemple, si tu veux \ndupliquer un objet de cette salle vers le CheminInquiétant d'où tu es venu, tu faire \ncp [OBJET_À_COPIER] ../[NOUVEAU_NOM_OBJET]. Tu peux faire cela pour la plupart des sorts et la plupart des salles. \nUtilise cette connaissance avec prudence. Souviens-toi… tu ne peux pas annuler un sort « rm ».",
...
people_supertroll_rm:"Le troll émet un rot spectaculaire, puis un sourire narquois. Tu ne pourras pas te débarrasser de lui facilement, pas sans le « mot de passe sudo ». Ce n'est pas « pseudo », c'est « sudo » ! Tu peux le trouver dans les FichiersNoyau. Mais d'abord tu dois te débarrasser du TrollMoche.",
people_supertroll_mv:"Si tu le fais sortir de la grotte, il ira semer la terreur dans le pays.\nIl voudra aussi probablement te manger.",
room_cage:"Cage",
room_cage_text:"Il y a un enfant terrifié dans cette cage.",
room_cage_cd:"Tu ne peux pas te faufiler entre les barreaux de la cage. Et puis, ça va pas la tête ?\nPourquoi voudrais-tu aller dans cette cage ? Tu envies le sort des animaux à fourrure ?\nCe {{people_supertroll}} pourrait te dépecer comme une clémentine.",
...
people_kidnapped_mv:"L'enfant regarde autour de lui, confus, surpris de se trouver hors de la cage.\nTu lui souris et lui dis avec une voix douce : \n<voice char> « Tu devrais rentrer chez toi p'tit gars. » \n<voice girl>\"Je suis une fille avec des cheveux courts. Pas un garçon manqué. Une fille ! Pourquoi il faut toujours être un garçon par défaut ? \", <voice char> dit la petite fille.\nAvant de se précipiter vers la sortie, elle en profite pour donner un coup de pied dans le genou du {{people_supertroll}}.<voice girl>\"Je t'avais dit de me lâcher !\"\n<voice char>Le {{people_supertroll}} se met alors à pleurer tandis que la petite s'échappe.",
...
cmd_poe_revealed:"cmd_poe_revealed",
po_symbol_edit:"(édition - taper Ctrl + Entrée pour valider) ",
po_symbol_unknown:"po_symbol_unknown",
};
